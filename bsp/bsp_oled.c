...
void bsp_oled_show_str(uint8_t x, uint8_t page, const char *str)
{
...
void bsp_oled_show_num(uint8_t x, uint8_t page, int32_t num, uint8_t len)
{
    char buf[12];
    uint8_t i = 0;
    uint8_t neg = 0;
